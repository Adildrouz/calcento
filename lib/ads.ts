// Ad slot IDs for each calculator page.
// Get these from AdSense → Ads → By ad unit → Display ads → create/copy the slot ID.
// Leave as undefined until you have a real ID — AdSlot renders a placeholder instead.
